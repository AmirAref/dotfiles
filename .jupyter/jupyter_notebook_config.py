...
c.ContentsManager.untitled_directory = 'A Untitled Folder'
...
#  Choices: any of ['sha3_224', 'sha512', 'sha3_512', 'md5', 'blake2s', 'sha224', 'sha3_384', 'sha3_256', 'sha256', 'sha1', 'sha384', 'blake2b']
#  Default: 'sha256'
# c.NotebookNotary.algorithm = 'sha256'

## The storage directory for notary secret and database.
#  Default: ''
c.NotebookNotary.data_dir = '$HOME/Documents/Programming/python/Jupyter/'
